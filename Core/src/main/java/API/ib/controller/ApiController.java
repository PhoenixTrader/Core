...
import API.ib.client.*;
import API.ib.client.Types.BarSize;
import API.ib.client.Types.DeepSide;
import API.ib.client.Types.DeepType;
import API.ib.client.Types.DurationUnit;
import API.ib.client.Types.ExerciseType;
import API.ib.client.Types.FADataType;
import API.ib.client.Types.FundamentalType;
import API.ib.client.Types.NewsType;
import API.ib.client.Types.WhatToShow;
import API.ib.controller.ApiConnection.ILogger;
...
public class ApiController implements EWrapper {
	...
	@Override public void historicalData(int reqId, API.ib.client.Bar bar) {
    ...
    @Override
    public void historicalDataUpdate(int reqId, API.ib.client.Bar bar) {
