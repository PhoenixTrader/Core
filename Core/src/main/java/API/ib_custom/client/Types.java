...
package API.ib_custom.client;

import java.util.Arrays;

import static API.ib_custom.client.Types.AlgoParam.allowPastEndTime;
import static API.ib_custom.client.Types.AlgoParam.catchUp;
import static API.ib_custom.client.Types.AlgoParam.componentSize;
import static API.ib_custom.client.Types.AlgoParam.displaySize;
import static API.ib_custom.client.Types.AlgoParam.endTime;
import static API.ib_custom.client.Types.AlgoParam.forceCompletion;
import static API.ib_custom.client.Types.AlgoParam.getDone;
import static API.ib_custom.client.Types.AlgoParam.giveUp;
import static API.ib_custom.client.Types.AlgoParam.maxPctVol;
import static API.ib_custom.client.Types.AlgoParam.noTakeLiq;
import static API.ib_custom.client.Types.AlgoParam.noTradeAhead;
import static API.ib_custom.client.Types.AlgoParam.pctVol;
import static API.ib_custom.client.Types.AlgoParam.randomizeSize55;
import static API.ib_custom.client.Types.AlgoParam.randomizeTime20;
import static API.ib_custom.client.Types.AlgoParam.riskAversion;
import static API.ib_custom.client.Types.AlgoParam.startTime;
import static API.ib_custom.client.Types.AlgoParam.strategyType;
import static API.ib_custom.client.Types.AlgoParam.timeBetweenOrders;
import static API.ib_custom.client.Types.AlgoParam.useOddLots;
import static API.ib_custom.client.Types.AlgoParam.waitForFill;
