...
public class GetCalendar {
	...
	public Multimap<String, List<String>> TestMultimap(Integer counter, List<String> events, List<String> currencies,
			List<String> times, List<String> actuals) {
		Multimap<String, List<String>> eventDictionary = ArrayListMultimap.create();
		for (int i = 0; i < counter; i++) {
	 ...
	 * multimap.put(1, "A"); multimap.put(1, "B"); multimap.put(1, "C");
	 * multimap.put(1, "A");
	 * 
	 * multimap.put(2, "A"); multimap.put(2, "B"); multimap.put(2, "C");
	 * 
	 * multimap.put(3, "A");
	 * 
	...
	public void createCSV(ZonedDateTime dateFromeDF) {
		...
		/*
		 * builder.append(columnNamesList +"\n"); builder.append("1"+",");
		 * builder.append("Chola"); builder.append('\n');
		 */
	...
	public List<String> zonedDatetime(LocalDate localDate, List<String> listCalendarTime) {
		List<String> calendarDateTimes = new ArrayList<>();
		String calendarTime;
		for (int i = 0; i < listCalendarTime.size(); i++) {
			...
			int checkerlength = checker.length();
			if (checkerlength == 8) {
				calendarTime = createcalendarDateTime(localDate, listCalendarTime.get(i));
				calendarDateTimes.add(calendarTime);
			} else {
				int previousCounter = i - 1;
				calendarTime = createcalendarDateTime(localDate, listCalendarTime.get(previousCounter));
				calendarDateTimes.add(calendarTime);
			}
		}
