...
import IB_connect.ib.client.Types.ExerciseType;
import IB_connect.ib.client.Types.FADataType;
import IB_connect.ib.client.Types.FundamentalType;
import IB_connect.ib.client.Types.NewsType;
import IB_connect.ib.client.Types.WhatToShow;
import IB_connect.ib.controller.ApiConnection.ILogger;
...
public class ApiController implements EWrapper {
	...
	@Override public void historicalData(int reqId, IB_connect.ib.client.Bar bar) {
    ...
    @Override
    public void historicalDataUpdate(int reqId, IB_connect.ib.client.Bar bar) {
